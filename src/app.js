...
App = {
  ...
  loadContract: async () => {
    ...
    //places todoList.json in a truffle wrapper and points to the address 
    //on the blockchain where the contract is located.
  ...
  render: async () => {
    ...
    //#account references the account id established in HTML
